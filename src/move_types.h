...
#define TOSQ(M) M & 0b00000000000000000000111111000000
#define PIECE(M) M & 0b00000000000000000111000000000000
#define CAPTURED_PIECE(M) M & 0b00000000000000111000000000000000
#define PROMOTED_PIECE(M) M & 0b00000000000111000000000000000000
#define EN_PASSANT_SQ(M) M & 0b00001111110000000000000000000000
#define TYPE(M) M & 0b01110000000000000000000000000000
